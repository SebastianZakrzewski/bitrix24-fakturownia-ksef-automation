...
export function buildBitrixE2eSetupReport(
  ...
  return {
    ...
    bitrixCompanyId: execution.bitrixCompanyId,
    bitrixCompanyReusedExisting: execution.bitrixCompanyReusedExisting,
    bitrixCompanyCreated: execution.bitrixCompanyCreated,
